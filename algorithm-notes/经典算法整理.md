...
第一种：
  ...
  ![](assets/Snip20190601_19.png)
  ![](assets/Snip20190601_20.png)
  ![](assets/Snip20190601_21.png)
  ![](assets/Snip20190601_22.png)

第二种：

  ![](assets/Snip20190601_28.png)
  ![](assets/Snip20190601_29.png)
  ![](assets/Snip20190601_12.png)
  ![](assets/Snip20190601_13.png)
...
<div align="center"> <img src="assets/1024555-20161218163120151-452283750.png" width="60%" height="60%" /> </div>
**代码实现：**
...
- 再字符串的`开头`添加字符，使其成为回文串，求其中最短的
  ...
  ![](assets/Snip20190601_3.png)
  只要将后面的字符逆序添加到开头即可

- 再字符串的`末尾`添加字符，使其成为回文串，求其中最短的
  `CBA`
   ![](assets/Snip20190601_4.png)

### Manacher

#### 几个概念
回文半径，回文左右边界：
![](assets/Snip20190601_5.png)
两种情况：
...
- 若当前考察的位置包括在回文半径内，则又有下面三种情况
  ...
  1. 若i点关于c的镜像i0在L内部，此时i的回文半径和i0相同，为什么？
     ![](assets/2019-06-01_091041.png)

  2. 若i点关于c的镜像i0在L外部，则回文半径最就是和R的距离，为什么？
     ![](assets/2019-06-01_091925.png)
     证明如下：
     ...
     ![](assets/2019-06-01_141524.png)

  3. 若i点关于c的镜像i0等于L，此时需要考察R之后的字符才能确定。
     ![](assets/2019-06-01_092247.png)
#### 代码实现
```java
// #A#B#C#C#E#
...
### 求两个排序数组的上中位数(长度相等)
  ...
  ![](assets/Snip20190601_14-9385620.png)
